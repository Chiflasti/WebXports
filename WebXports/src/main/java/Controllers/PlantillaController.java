...
public class PlantillaController {
	...
	public void init() {
		...
		repository.save(new Plantilla("The Jungle One","Aitor","Tilla","Jungla","Española","Team Cheese"));//team cheese
		...
		repository.save(new Plantilla("Cacahuate","Jack","Daniels","Jungla","Escocesa","Movistar Titans"));//Moviestar titans
		...
		repository.save(new Plantilla("LardLard","Igor","Dito","Jungla","Rusa","eMonos"));//eMonos
		...
		repository.save(new Plantilla("Levitica","Elsa","Kapunta","Jungla","Israeli","Comando Sevilla"));///Comando Sevilla
